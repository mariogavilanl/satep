<script>
    ...
    <div class="container">
        <div class="row">
            <form action="/api/getExamenaa">
    
            <div class="col-12 row">
             
                <div class="form-group col-2">
                    <label for="">FECHA FLUJOMETRIA 1</label>
                    <input id="FECHA_FLUJO1" name="FECHAFLUJO1" width="276" />
                ...
                <div class="form-group col-2">
                    <label for="">FECHA FLUJOMETRIA 2</label>
                    <input id="FECHA_FLUJO2" name="FECHAFLUJO2" width="276" />
                ...
                <div class="form-group col-2">
                    ...
                    <input id="FECHA_ENCUESTA" name="FECHAENCUESTA" width="276" />
