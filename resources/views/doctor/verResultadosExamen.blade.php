            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Fecha Contramuestra</th>
                
                        <th>UG/G Contramuestra</th>
                        <th>Esado Contramuestra</th>
                    </tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{$examen->as_FECHALAB2}}</td>
                        <td>{{$examen->as_FECHA_CONTRAMUESTRA}}</td>
                        <td>{{$examen->as_UG_G_CONTRAMUESTRA}}</td>
                        <td>{{$examen->as_estado1}}</td>
                    </tr>
                </tbody>
            </table>
